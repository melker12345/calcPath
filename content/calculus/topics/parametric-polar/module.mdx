...
- Find the intersections: $2(1 + \cos \theta) = 2 \Rightarrow \cos \theta = 0 \Rightarrow \theta = \pm \tfrac{\pi}{2}$.
- Test which curve is outer between them: at $\theta = 0$ the cardioid has $r = 4$ while the circle has $r = 2$, so the cardioid is the outer curve on $(-\tfrac{\pi}{2}, \tfrac{\pi}{2})$.
- Set up the area with the cardioid as outer and the circle as inner: $A = \frac{1}{2} \int_{-\pi/2}^{\pi/2} \left[(2 + 2\cos \theta)^2 - 2^2\right] d\theta$.
- Expand the integrand: $(2 + 2\cos\theta)^2 - 4 = 8\cos\theta + 4\cos^2\theta = 8\cos\theta + 2(1 + \cos 2\theta)$.
- Integrate: $A = \frac{1}{2}\left[\,8\sin\theta + 2\theta + \sin 2\theta\,\right]_{-\pi/2}^{\pi/2} = \frac{1}{2}\big[(8 + \pi) - (-8 - \pi)\big] = \frac{1}{2}(16 + 2\pi)$.
- The area is $8 + \pi$.
