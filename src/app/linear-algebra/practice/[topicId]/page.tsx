      ...
      <div className="la-card flex min-h-[calc(100dvh-56px)] flex-col justify-end px-4 pb-1 pt-2 sm:min-h-[min(80vh,700px)] sm:rounded-2xl sm:border sm:px-8 sm:pb-6 sm:pt-6 sm:shadow-lg">
          ...
          <div className="mt-1 grid grid-cols-[1fr_auto_1fr] items-center py-1 sm:mt-3 sm:py-0">
            ...
            <div
              ...
              style={{ color: "rgba(226,232,240,0.6)", borderColor: "rgba(51,114,162,0.25)" }}
            >
              Q{canonicalQuestionNumber}
            </div>
            <Link className="justify-self-end rounded-lg px-2.5 py-1 text-xs font-medium transition sm:text-sm" style={{ color: "rgba(226,232,240,0.5)" }} href="/linear-algebra/practice">
              All topics
            </Link>
          </div>
        </div>
