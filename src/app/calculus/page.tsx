...
export const metadata: Metadata = {
  ...
  description:
    "Learn calculus step by step. Free university-level course covering limits, derivatives, integrals, sequences, series, and multivariable calculus. 360+ practice problems with full worked solutions.",
...
const courseJsonLd = {
  ...
  name: "Calculus",
  description:
    "Free university calculus course covering limits, derivatives, integrals, sequences and series, multivariable calculus, and differential equations. Includes 360+ practice problems with step-by-step solutions.",
  provider: {
    "@type": "Organization",
    name: "CalcPath",
