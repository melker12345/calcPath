  ...
  return (
    <div className="px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mb-8 border-b border-[var(--border)] pb-6">
        ...
        <p className="mt-3 text-sm text-emerald-700 dark:text-emerald-400 theme-text-secondary">
            ...
            <div key={topic.id} className="flex flex-col gap-2 rounded-xl border border-[var(--border)] bg-white p-4 dark:bg-[var(--surface)] sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex shrink-0 flex-wrap gap-2 pt-2 sm:pt-0">
                <Link
                  ...
                  className={`rounded-lg px-3 py-1.5 text-sm font-medium transition ${hasMdx ? "bg-blue-600 text-white hover:bg-blue-700" : "cursor-not-allowed bg-zinc-200 text-zinc-500 dark:bg-zinc-800 dark:text-[var(--text-muted)]"}`}
                ...
                <Link
                  ...
                  className={`rounded-lg px-3 py-1.5 text-sm font-medium transition ${hasPractice ? "border border-emerald-600 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-800 dark:text-emerald-400 dark:hover:bg-emerald-950/30" : "cursor-not-allowed bg-zinc-200 text-zinc-500 dark:bg-zinc-800 dark:text-[var(--text-muted)]"}`}
      ...
      <div className="mt-8 rounded border border-dashed border-zinc-300 p-4 text-xs theme-text-muted dark:border-zinc-700">
