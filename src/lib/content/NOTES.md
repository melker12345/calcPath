...
- [x] (Linear Algebra Completion Agent) Updated subject index.json with all 9 topics. Ported full 40 questions + full rich MDX (converted from structured legacy) for "vectors". Created dirs for remaining 8. Small commits. Next: repeat for other 8 topics using automated extraction + MDX render.
